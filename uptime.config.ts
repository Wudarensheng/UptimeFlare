...
const pageConfig: PageConfig = {
  ...
  title: "Wudarensheng 的状态页",
  // Links shown at the header of your status page, could set `highlight` to `true`
  links: [
    { link: 'https://github.com/Wudarensheng', label: 'GitHub' },
    { link: 'https://blog.wudarensheng.top/', label: '博客' },
  ],
}
...
const workerConfig: WorkerConfig = {
  ...
  monitors: [
    ...
    },
    {
      ...
      name: '博客 -Cloudflare',
      method: 'HEAD',
      target: 'https://blog.wudarensheng.top/',
      statusPageLink: 'https://blog.wudarensheng.top/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },

    {
      ...
      name: 'Umami（Edgeone）',
      method: 'HEAD',
      target: 'https://umami.wudarensheng.top/',
      statusPageLink: 'https://umami.wudarensheng.top/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
